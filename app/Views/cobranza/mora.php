          ...
          <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              ...
              <li class="breadcrumb-item">
                <a href="<?php echo base_url('/generador')?>"  class="btn btn-success upgrade-to-pro">Generar Cobranza</a>
                </li>
                <li class="breadcrumb-item">
                <a href="<?php echo base_url('/crearcobranza')?>"  class="btn btn-success upgrade-to-pro">Nueva Cobranza</a>
                </li>
              </ol>
            </div>
          </div>
                        ...
                        <div class="card-body collapse in">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                            <?php foreach ($cobro as $i) : ?>
                                                <tr>
                                                <td><?= $i['id_cobranza'] ?></td>
                                                <td><?= $i['codigo_propietario'] ?></td>
                                                <td><?= $i['id_inquilino'] ?></td>
                                                <td><?= $i['fecha'] ?></td>
                                                <td><?= $i['concepto'] ?></td>
                                                <td><?= $i['periodo'] ?></td>
                                                <td><?= $i['mora'] ?></td>
